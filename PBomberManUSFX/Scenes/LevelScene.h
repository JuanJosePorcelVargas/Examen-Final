...
private:
    ...
    //*******************************************************
    void spawnHielo(const int positionX, const int positionY);
    //*********************************************************
    ...
    //*********************************************************************************
    std::vector<std::pair<GameTile, std::shared_ptr<GameGraphicObject>>> lento;
    //**********************************************************************************
    std::vector<std::pair<GameTile, std::shared_ptr<GameGraphicObject>>> normal;
    //********************************************************************************
