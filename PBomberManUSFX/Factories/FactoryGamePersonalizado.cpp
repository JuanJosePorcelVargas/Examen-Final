...
{
    // spawn player
    auto player = std::make_shared<PersonalizadoPlayer>(gameManager->getAssetManager()->getTexture(GameTexture::Player), gameManager->getRenderer());
    ...
    std::cout << "Dentro FactoryGameCustom" << endl;
